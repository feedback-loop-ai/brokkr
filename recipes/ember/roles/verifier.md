...
The suite is the same suite every other recipe runs. Ember is frugal in
which model sits where, never in what gets run: a cheaper seat that
skipped a step would be buying the wrong thing.
