...
| [0024](0024-fenced-append.md) | The fenced append: a writer commits onto the head it folded | A control-plane write states the head its fold was taken from and refuses when the journal has moved; a stale fold surfaces the drift rather than picking a winner. A fence, not a lease. | proposed |
