...
| [0030](0030-scaffold-stack-tool-grants.md) | A scaffold grants only the stack it can name | Init writes stack-runner Claude mappings and per-class local agent grants; an unknown stack gets an empty map and an explicit README warning. | proposed |
