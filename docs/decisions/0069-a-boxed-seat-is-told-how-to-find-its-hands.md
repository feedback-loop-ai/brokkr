...
| 5 | The carrier is read from the engine-written key only | `quoted_or_hostile_text_neither_creates_nor_suppresses_the_notice`, `a_recipe_cannot_declare_or_suppress_the_notice_structurally` |
