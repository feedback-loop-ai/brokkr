...
pulled forward): the full Alkemio-shaped machinery is not built until the
...
LaneTally integration, and the Alkemio profile.
...
- The self bundle's phase table is bundle data, not a fork of the imported
  ...
  parity material.
- The Alkemio vertical slice (delivery-sequence step 6 as originally
