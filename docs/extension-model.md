...
overrides, workspace conventions. the origin workspace's profile stays private in
origin-workspace; the public repo ships an example. Profiles are declarative bundle
