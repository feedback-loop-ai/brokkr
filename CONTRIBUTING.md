...
[0009](docs/decisions/0009-rust-only.md)): no Python, no Node, no
...
decision [0018](docs/decisions/0018-dual-license.md) — openness that
imposes nothing.
...
[`docs/decisions/`](docs/decisions/), kept in full and cited by number
...
[`docs/decisions/README.md`](docs/decisions/README.md) carries the
...
1. **`brokkr compile`.** Every recipe and bundle in the tree is compiled
   ...
   [0021](docs/decisions/0021-model-policy.md)).
...
[`docs/guides/recipe-authoring.md`](docs/guides/recipe-authoring.md) —
...
[`docs/guides/driver-authoring.md`](docs/guides/driver-authoring.md) for
...
[0021](docs/decisions/0021-model-policy.md)) — so an adapter change is a
