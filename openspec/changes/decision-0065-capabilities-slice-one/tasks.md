...
without replay or replacement. The proposal, deltas and D5 design need no
rewrite. The implementation remains adopted, but the evidence audit below
...
and evidence.md; this council visit also amends design.md as the dialect
requires. A fourth production file, another suite or a measured pin edit requires an inventoried split **before** editing. No new module,
