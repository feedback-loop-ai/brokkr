...
pub struct RunEntry<'a> {
    ...
    /// is repaired here (determinism law 2) — the refusal is reported.
...
pub struct RealmRuns {
    ...
    /// nothing is repaired — the refusal is reported (determinism law 2).
    pub detail: Option<String>,
}
    ...
    for event in events {
        match event.event_type {
            ...
            EventType::TransitionDecided => {
                ...
                // one (determinism law 2, `docs/guides/overview.md`).
